      ...
      <tbody>
        ...
        <tr>
          ...
          <td width="" style="padding-bottom:35px">
            <span style="font-size:24px; font-weight:bold"
              >Temario Bootcamp Full-Stack</span
            >
          </td>
          <td width="33" style="min-width:33px">&nbsp;</td>
        </tr>
        <tr>
          ...
          <td width="" style="padding-bottom:54px">
            <p>
              Aquí tienes el temario que nos has pedido. Si tienes cualquier
              duda
              <a
                href="https://campus.boream.com/contacta-boream.html"
                target="_blank"
        ...
        <tr>
          ...
          <td width="" style="padding-bottom:54px">
            <a
              href="https://campus.boream.com/temario-bootcamp.pdf"
              class="btn"
              style="display:inline-block;border:1px solid #01C3B2;border-radius:24px;padding:12px 38px;color:#01C3B2;font-size:18px;text-decoration:none;
text-decoration:none;"
              >Descargar temario</a
            >
          </td>
