      ...
      <tbody>
        ...
        <tr>
          ...
          <td width="" style="padding-bottom:28px">
            <p>
              Hemos recibido tu
              <span style="color:#01C3B2">solicitud de contacto</span>
              correctamente.
            </p>
          </td>
          <td width="33" style="min-width:33px">&nbsp;</td>
        ...
        <tr>
          ...
          <td width="" style="padding-bottom:54px">
            <p>
              Déjanos unas horas para poder procesarla y te responderemos o te
              llamaremos tan pronto como nos sea posible
            </p>
          </td>
          <td width="33" style="min-width:33px">&nbsp;</td>
        </tr>
