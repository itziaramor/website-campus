      ...
      <tbody>
        ...
        <tr>
          ...
          <td width="" style="padding-bottom:35px">
            <span style="font-size:24px; font-weight:bold">Solicitud de información recibida!</span>
          </td>
          <td width="33" style="min-width:33px">&nbsp;</td>
        </tr>
        <tr>
          ...
          >
            <table>
              <tbody>
                <tr>
                  <td width="24">&nbsp;</td>
                  <td width="486" style="padding-top:72px;padding-bottom:34px">
                    <img
                      src="https://campus.boream.com/assets/images/email/logo-bootcamp.png"
                      alt="Logo bootcamp"
                      width="44"
                    ...
                    <p style="font-weight:lighter;color:#9DE7AC">
                      EL 100% DE NUESTROS ALUMNOS<br />TRABAJAN COMO
                      PROGRAMADORES
                    </p>
                  </td>
                  <td width="24">&nbsp;</td>
        ...
        <tr>
          ...
          <td width="" style="padding-top:24px; padding-bottom:28px">
            <p>
              ...
              <span style="color:#01C3B2">Bootcamp Full Stack Developer</span>.
            </p>
          </td>
          <td width="33" style="min-width:33px">&nbsp;</td>
        </tr>
        ...
        <tr>
          ...
          <td width="" style="padding-bottom:54px">
            <p>
              ...
              <a
                href="https://campus.boream.com/bootcamp-full-stack-developer.html#preguntas"
                target="_blank"
                style="text-decoration: underline;"
                >un vistazo a las FAQs</a
              >
            </p>
          </td>
          <td width="33" style="min-width:33px">&nbsp;</td>
              ...
              <tbody>
                <tr>
                  <td width="44" valign="bottom">
                    <a href="https://www.linkedin.com/company/boream/" target="_blank" style="display:block" title="Sigue a Boream en Linkedin">
                      <img width="34" src="https://campus.boream.com/assets/images/email/linkedin.png" alt="Boream en Linkedin" style="max-width: 34px;height:auto;width:100%;border:0;display:block" />
                    </a>
                  </td>
                  <td width="44" valign="bottom">
                    <a href="https://twitter.com/boreamoficial" target="_blank" style="display:block" title="Sigue a Boream en Twitter">
                      <img width="34" src="https://campus.boream.com/assets/images/email/twitter.png" alt="Boream en Twitter" style="max-width: 34px;height:auto;width:100%;border:0;display:block" />
                    </a>
                  </td>
                  <td width="44" valign="bottom">
                    <a href="https://www.facebook.com/BoreamOficial/" target="_blank" style="display:block" title="Sigue a Boream en Facebook">
                      <img width="34" src="https://campus.boream.com/assets/images/email/facebook.png" alt="Boream en Facebook" style="max-width: 34px;height:auto;width:100%;border:0;display:block" />
                    </a>
                  </td>
                  <td width="44" valign="bottom">
                    <a href="https://www.instagram.com/boreamoficial/" target="_blank" style="display:block" title="Sigue a Boream en Instagram">
                      <img width="34" src="https://campus.boream.com/assets/images/email/instagram.png" alt="Boream en Instagram" style="max-width: 34px;height:auto;width:100%;border:0;display:block" />
                    </a>
                  </td>
                </tr>
              </tbody>
